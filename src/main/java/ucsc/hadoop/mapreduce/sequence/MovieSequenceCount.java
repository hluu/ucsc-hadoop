package ucsc.hadoop.mapreduce.sequence;
...
/**
 * Simple MapReduce application to count how many movies per year and it works with sequence data
 * 
 * This M/R application reads data in sequence format using {@link SequenceInputFormat} and it will write data out
 * in sequence format as well using {@link SequenceOutputFormat}
 * 
 * @author hluu
 *
 */
public class MovieSequenceCount extends Configured implements Tool {
	
	private static final Log LOG = LogFactory.getLog(MovieSequenceCount.class);
	...
	public int run(String[] args) throws Exception {
		...
		job.setJarByClass(MovieSequenceCount.class);
	...
	public static void main(String[] args) throws Exception {
		int exitCode = ToolRunner.run(new MovieSequenceCount(), args);
